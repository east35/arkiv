...
export function CollectionTableRow({ collection, stacked = false, isFirst = false }: CollectionTableRowProps) {
  ...
  return (
    ...
    >
      <Link to={`/collections/${collection.id}`} className="flex flex-1 min-w-0 items-center gap-4 px-4 py-3">
        {/* Cover thumbnail */}
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-medium leading-none truncate">{collection.name}</h3>
